...
export class CreateHealthRecordDto {
  ...
  @ValidateIf(
    (o: CreateHealthRecordDto) => o.recordType === HealthRecordType.LAB_TEST,
  )
  @IsString()
  @IsNotEmpty()
  ...
  @ValidateIf(
    (o: CreateHealthRecordDto) => o.recordType === HealthRecordType.MEDICATION,
  )
  @IsString()
  @IsNotEmpty()
  declare drug?: string;
  ...
  @ValidateIf(
    (o: CreateHealthRecordDto) => o.recordType === HealthRecordType.ALLERGY,
  )
  @IsEnum(AllergyType)
