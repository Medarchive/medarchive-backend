...
export class MedicalProfileController {
  ...
  @ApiOperation({
    ...
    description:
      'Returns blood group, genotype, height, weight, medication status, and active conditions.',
  })
  @ApiResponse({
    status: 200,
    schema: {
      allOf: [
        ...
        {
          properties: {
            message: { example: 'Medical profile fetched successfully' },
          },
        },
      ],
    },
  ...
  @ApiResponse({
    ...
    schema: {
      allOf: [
        ...
        {
          properties: {
            message: { example: 'Medical profile updated successfully' },
          },
        },
      ],
    },
