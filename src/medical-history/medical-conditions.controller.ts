...
export class MedicalConditionsController {
  ...
  @ApiOperation({
    summary: '[Admin] Create a medical condition',
  ...
  @ApiOperation({
    ...
    description:
      'Stub — not yet implemented. Will invalidate the active conditions cache on update.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Stub — not yet implemented. Will invalidate the active conditions cache on deactivation.',
  })
