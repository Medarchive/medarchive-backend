  ...
  @ApiResponse({
    ...
    schema: {
      allOf: [
        ...
        {
          properties: {
            message: { example: 'Emergency contact added successfully' },
          },
        },
      ],
    },
  ...
  @ApiResponse({
    ...
    schema: {
      allOf: [
        ...
        {
          properties: {
            message: { example: 'Emergency contacts fetched successfully' },
          },
        },
      ],
    },
  ...
  @ApiResponse({
    ...
    schema: {
      allOf: [
        ...
        {
          properties: {
            message: { example: 'Emergency contact updated successfully' },
          },
        },
      ],
    },
